...
class _ProfileTabState extends State<ProfileTab> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (_authController.user.value != null) {
        print('🔄 [PROFILE TAB] Refreshing user profile...');
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(() {
                ...
                final userData = _getUserData(user, _authController);
  ...
  Map<String, String> _getUserData(user, AuthController authController) {
    if (user == null) {
      return {};
    }
